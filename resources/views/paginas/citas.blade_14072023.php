                                ...
                                <form action="{{url('/')}}/citas-crear" class="bg-light needs-validation" method="post" novalidate>
                                    ...
                                    <div class="modal-body" id="modal-body-crear">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input id="hora" type="time" class="form-control hora"
                                                           name="hora" value="{{date( 'H:i', strtotime(now()) ) }}" required   autofocus>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mt-4">
                                            <div class="col-sm-12">
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input  id="buscaPaciente" type="search" class="form-control hora"
                                                           name="buscaPaciente" value=""  placeholder="Buscar Paciente"
                                                            action="{{url('/')}}/pacientes-buscar"
                                                    >
                                                    @csrf
                                                </div>
                                            </div>
                                        ...
                                        <div class="row error d-none">
                                            <div class="alert alert-danger alert-dismissible fade show col-sm-12 text-center">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-light cancelar" data-dismiss="modal">Cancelar</button>
