                  ...
                  <div class="row mt-3">
                    <div class="col-md-6">
                      <div class="input-group mb-3">
                        ...
                        <input id="date" type="date" class="form-control pac_nacimiento @error('pac_naciemiento')
                        is-invalid @enderror" name="pac_nacimiento" value="{{ date('Y-m-d') }}" required
