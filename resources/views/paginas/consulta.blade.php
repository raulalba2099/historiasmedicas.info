...
@section('content')
                                                           ...
                                                           Porcentaje de Grasa
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input class="form-control text-right presion_arterial"
                                                                       ...
                                                                       name="exa_grasa"
                                                                       id="exaGrasa"
                                                                       value="{{ (!empty($fisico) ? $fisico->exa_grasa : '' )  }}">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-4">
                                                           Porcentaje de músculo
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input class="form-control text-right presion_arterial"
                                                                       ...
                                                                       value="{{ (!empty($fisico) ? $fisico->exa_musculo : '' )  }}">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-4">
                                                    ...
                                                    <div class="row mt-3">
                                                        <div class="col-sm-4">
                                                            ...
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input class="form-control text-right" type="text"
                                                                       name="exa_metabolica" id="exa_metabolica"
                                                                       value="{{ (!empty($fisico) ? $fisico->exa_metabolica : '' )  }}">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-4">
                                                            Kilos Totales
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input class="form-control text-right" type="text"
                                                                       ...
                                                                       value="{{ (!empty($fisico) ? $fisico->exa_kilos : '' )  }}">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-4">
                                                            ...
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input class="form-control text-right" type="text"
                                                                       ...
                                                                       value="{{!empty($fisico) ? $fisico->exa_cmb : '' }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row mt-3">
                                                        <div class="col-sm-4">
                                                            ...
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input class="form-control text-right" type="text"
                                                                       ...
                                                                       value="{{!empty($fisico) ? $fisico->exa_cci : '' }}">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-4">
                                                            ...
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input class="form-control text-right"
                                                                       ...
                                                                       value="{{!empty($fisico) ? $fisico->exa_cca : '' }}">
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-4">
                                                            Peso
                                                ...
                                                <table id="tablaNotas"
                                                    ...
                                                    @foreach($notas as $nota)
                                                        <tr>
                                                            ...
                                                            <td id="notaDes" class="text-justify">{!! nl2br($nota->not_descripcion) !!}</td>
                                        ...
                                        <div class="col-sm-10 m-2 m-auto">
                                            @if($statusReceta == 400)
                                                ...
                                                <div class="row container container-fluid mb-5 caja-mediana p-4 ">
                                                    ...
                                                    <form action="{{url('/')}}/receta"
                                                          class="bg-light form-inline w-100 p-4 "
                                                          method="post" novalidate name="agregaRecetaForm"
                                                          id="recetaForm">
                                                        @csrf
                                                        ...
                                                        <span
                                                            class="col-sm-7 text-center font-weight-bold">Medicamento</span>
                                                        <span class="col-sm-2 text-center font-weight-bold">Dosis</span>
                                                        <span
                                                            class="col-sm-2 text-center font-weight-bold">Duración</span>
                                                        <span class="col-sm-1"></span>
                                                        <div class="col-sm-12 mt-2 float-right d-none">
                                                            <button type="submit" name="guardarReceta"
                                                                    id="btnGuardarReceta"
                                            ...
                                            @else
                                                <div class="container mb-5 mt-5">
                                                    <div class="row">
                                                        <div class="col-sm-1">
                                                            <button title="Modificar Receta" title="Agregar"
                                                                    id="btnNuevoReceta"
                                                                    type="button"
                                                        ...
                                                        <div class="col-sm-2 mt-5 mt-sm-0 ml-md-4 ml-lg-0">
                                                            <a href="{{ url('/') }}/receta_pdf/{{$consulta->cit_id}}"
                                                               title="Descargar Receta" title="Agregar"
                                                               id="btnNuevoReceta"
                                                        ...
                                                        <div class="col-sm-2 mt-5 mt-sm-0 ml-md-4 ml-lg-0">
                                                            <a href="{{ url('/') }}/send_pdf/{{$consulta->cit_id}}"
                                                               title="Enviar Receta" title="Agregar"
                                                               id="btnEnviarReceta"
                                                ...
                                                <div class="caja-mediana">
                                                    ...
                                                    <div class="row container container-fluid mb-5 p-4" id="receta">
                                                        <form action="{{url('/')}}/receta"
                                                            ...
                                                            <span
                                                                class="col-sm-2 text-center font-weight-bold ">Dosis</span>
                                                            ...
                                                            @foreach($receta as $key => $medicamento)
                                                                ...
                                                                <input type="hidden" name="fila" class="fila" id="fila"
                                                                       value="{{$cantidadRegistros}}">
                                                                <a title="Eliminar"
                                                                   class="btn btn-danger btn-sm eliminarRegistro ml-2 mt-3 mt-md-0 text-white"
    ...
    <?php
       $titulosNota = 'Motivo de consulta: <br/> Notas';
    ?>
                            ...
                            <div class="col-md-12">
                                <div class="input-group mb-3">
                                    ...
                                    <textarea name="descripcion" id="nota" cols="" rows="5"
                                        ...
                                        <span style="font-weight: bold;">Exploración Física:</span> <br/>
                                        <span style="font-weight: bold;">Dianostico:</span> <br/>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="hidden" name="fecha" id="fecha" value=" {{date('Y-m-d')}} ">
                                        <textarea name="descripcion" id="nota" rows="5"
        ...
        <div class="modal-dialog " role="document">
            <div class="modal-content">
                ...
                <form action="{{url('/')}}/menu" class="bg-light "
                    ...
                    <div class="modal-footer">
                        <button type="button" id="cancelar-menu" class="btn btn-light" data-dismiss="modal">Cancelar
                        </button>
    ...
    <!--Agregar Correo -->
    <div class="modal fade" id="enviarReceta" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
         aria-hidden="true">
        <div class="modal-dialog modal-mediano" role="document">
            <div class="modal-content">
                <div class="modal-header bg-primary">
                ...
                <form action="{{url('/')}}/send_pdf" class="bg-light "
    ...
    @if (Session::has("mensaje-enviado"))
        ...
        <script>
            notie.alert({type: 1, text: '¡La Receta ha sido enviada correctamente!', time: 10})
        </script>
    ...
    @if (Session::has("mensaje-error"))
        ...
        <script>
            notie.alert({type: 3, text: '¡La Receta no se  enviado. Intente de nuevo.!', time: 10})
        </script>
