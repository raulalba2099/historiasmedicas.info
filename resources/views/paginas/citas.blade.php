...
@section('content')
        ...
        <section class="content">
            <div class="container-fluid">
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <button style="cursor:pointer" class="btn btn-primary btn-sm" data-toggle="modal"
                                        data-target="#crearCita">
                                    <i class="nav-icon fas fa-calendar-alt"></i>
                                    Crear Cita
                                </button>
                                <button style="cursor:pointer" class="btn btn-success btn-sm" data-toggle="modal"
                                        data-target="#crearPacienteCalendario">
                ...
                <script>
                  ...
                  ' ?>
                                <!--Crear Cita -->
                            <div class="modal fade" id="crearCita" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form action="{{url('/')}}/citas-nueva" class="bg-light needs-validation"
                                            ...
                                            <div class="modal-body" id="modal-body-crear">
                                                <div class="row">
                                                    <div class="col-12">
                                                            <!-- Select normal, Select2 lo reemplazará pero conservará la estructura -->
                                                            <select name="id"  id="paciente_id" class="form-control paciente_id" required></select>
                                                ...
                                                <div class="row mt-4">
                                                    <div class="col-md-12">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="hidden" name="mod_calendario"
                                                                   id="mod_calendario" value="1">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input id="hora" type="time" class="form-control hora"
                                                                   name="hora"
                                                                   value="{{date( 'H:i', strtotime(now()) ) }}" required
                                                                   autofocus>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-light cancelar"
                                                        data-dismiss="modal">Cancelar
                                                </button>
                                                <button type="submit" name="guardarCita" id="btnGuardarCita"
                            ...
                            <div class="row">
                                <div class="modal fade" id="crearPacienteCalendario" tabindex="-1" role="dialog"
                                    ...
                                    <div class="modal-dialog " style="" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form action="{{url('/')}}/pacientes" class="bg-light needs-validation"
                                                  method="post" novalidate>
                                                @csrf
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input id="pac_paterno" type="text"
                                                                       ...
                                                                       name="pac_paterno"
                                                                       value="{{ old('pac_paterno') }}" required
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input id="pac_materno" type="email"
                                                                       ...
                                                                       name="pac_materno"
                                                                       value="{{ old('pac_materno') }}"
                                                                       autocomplete="pac_materno"
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input id="date" type="text"
                                                                       ...
                                                                       name="pac_nacimiento"
                                                                       value="{{ old('pac_nacimiento') }}" required
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input id="pac_direccion" type="pac_direccion"
                                                                       ...
                                                                       name="pac_direccion"
                                                                       value="{{ old('pac_direccion') }}"
                                                                       autocomplete="pac_direccion"
                                                        ...
                                                        <div class="col-md-5">
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input id="pac_telefono" type="text"
                                                                       ...
                                                                       name="pac_telefono"
                                                                       value="{{ old('pac_telefono') }}" required
                                                                       autocomplete="pac_telefono"
                                                        ...
                                                        <div class="col-md-7">
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input id="pac_correo" type="email"
                                                                       ...
                                                                       name="pac_correo" value="{{ old('pac_correo') }}"
                                                                       placeholder="Correo">
                                                                <span class="invalid-feedback" role="alert">
                       {{$errors->first('pac_correo')}}
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="submit" name="guardarEquipo" id="btnGuardar"
    ...
    @if (Session::has("paciente-ya-existe"))

        <script>
            notie.alert({type: 2, text: '¡El Paciente  ya existe !', time: 10});
        </script>
