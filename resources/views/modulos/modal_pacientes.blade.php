                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            <div class="input-group mb-3 form-group">
                                ...
                                <input id="pac_nombre" type="pac_nombre" class="form-control pac_nombre @error('pac_nombre') is-invalid @enderror" name="pac_nombre" value="{{ old('pac_nombre') }}" placeholder="Nombre Paciente">
                                <span class="invalid-feedback" role="alert">
