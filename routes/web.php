...
use App\Http\Controllers\HistoriaClinicaSencillaController;
...
Route::get('/recetas', [RecetaController::class, 'mostrarPacientes'])->name('recetas');
Route::get('/recetas/{id}   ', [RecetaController::class, 'mostrarRecetas'])->name('recetas');
Route::get('/receta-expediente-cita/{id}/{fecha}', [RecetaController::class, 'mostrarReceta'])->name('receta');

Route::get('/menu_pdf/{id}', [MenuController::class, 'exportarPdf'])->name('menu.pdf');
Route::post('/sendMenu_pdf', [MenuController::class, 'sendMenu'])->name('sendMenu');
...
Route::get('/expediente-historia/{id}', [ExpedienteController::class, 'indexHistoriaSencillaAction'])->name('expediente');

Route::get('/expediente-menu/{id}', [ExpedienteController::class, 'indexMenuAction'])->name('expediente');
Route::get('/expediente-menu/{id}/{fecha}', [ExpedienteController::class, 'indexMenuAction'])->name('expediente');
//Route::get('/expediente-menu-mostrar/{id}/{fecha}', [ExpedienteController::class, 'mostrarMenuAction'])->name('expediente');
...
Route::get('/historia/{id}',[HistoriaClinicaSencillaController::class, 'index'])->name('historia');
Route::post('/historia',[HistoriaClinicaSencillaController::class, 'save'])->name('historia-save');
Route::post('/historia_sencilla/',[HistoriaClinicaSencillaController::class, 'save'])->name('historia-save');
