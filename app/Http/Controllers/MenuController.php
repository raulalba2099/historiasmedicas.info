...
//        return redirect("consulta/$request->cit_id")->with("ok-crear-menu", "");
    ...
    public function exportarPdf($id)
    {
        ...
        foreach ($comidasArray as $key => $comida) {
            ...
            if ($comida  == 'Ayunas' || $comida == 'Colación') {
                $colspan = 7;
            }
            if ($comida == 'Cena') {
...
//                $salto = '<div style=" page-break-before:always"></div>';
        ...
        $html = $html . '<div style="text-align: center; margin-top: 500px;">
                                <p>
                                    '.auth()->user()->name.'
                                </p>
                                <p> Cédula Profesional : 10362235</p>
                          </div>';

//        $html =  $html . '<table style="text-align: center; margin-top:200px; ">
//                    <tr>
//                        <td>
