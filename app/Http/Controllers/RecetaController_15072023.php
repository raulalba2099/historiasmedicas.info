...
//    }
    ...
    public function exdportarPdf($id) {
    ...
    try {
            ...
            $mail->Username   = 'consulta@historiasmedicas.info';                     //SMTP username
            $mail->Password   = 'eclrcjbslqwsqctn';                               //SMTP password
            $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;            //Enable implicit TLS encryption
            $mail->Port       = 465;                                    //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

            //Recipients
            $mail->setFrom('raulalba.2099@hotmail.com', 'Mailer');
            $mail->addAddress('raulalba.2099@hotmail.com', 'Joe User');     //Add a recipient
...
//            $pdf->Ln();
        ...
        $mail->From = 'raulalba2099@gmail.com';
        $mail->IsSMTP();
        $mail->Username = "raulalba2099@gmail.com";
        $mail->Password = "Aris2099*";
        $mail->SMTPSecure = "tls";
        $mail->Port = 587;
        $mail->FromName = 'Nombre remitente';
        $mail->Subject = 'Allegato in PDF';
    ...
    public function exdpdortarPdf($id)
    {
        $receta = Receta::where('rec_cit_id', $id)->join('citas', 'rec_cit_id', 'cit_id')
            ->join('pacientes', 'cit_pac_id', 'pac_id')->get();
...
//        $receta =
        ...
        $mail->AddStringAttachment('public/files/estudios/est_2_64.pdf', 'doc.pdf', 'base64', 'application/pdf');
